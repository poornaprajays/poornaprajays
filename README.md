...
Currently working as an **Intern** , contributing to **3D Bio-Acoustic Wildlife data acquisition and processing platform** that detects and classifies vast variety of **birds** ,**mammals** abd other **animals**,through their **vocalizations** using machine learning , artificial intelligence , MFCC , CNN , RAG and distributed IoT systems(Raspberry Pi) as the hardware.
