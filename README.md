...
Currently working as an **Intern** , contributing to **3D Bio-Acoustic Wildlife's data acquisition and data processing platform** that detects and classifies vast variety of **birds** ,**mammals** and other **animals** in the forest/jungle ,through their **vocalizations** using machine learning , artificial intelligence , MFCC , CNN , RAG and distributed IoT systems(Raspberry Pi) as the hardware.
